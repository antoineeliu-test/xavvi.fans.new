...
import { FaInstagram, FaTiktok, FaYoutube, FaFacebook, FaGlobe } from 'react-icons/fa';
...
export default function InfluencerCard({ influencer }: InfluencerCardProps) {
  const { name, profile_image_url, instagram_followers, tiktok_followers, youtube_followers, twitter_followers, facebook_followers, slug, website } = influencer;
  ...
  return (
    <Link href={`/influencer/${slug}`} className="group cursor-pointer h-full">
